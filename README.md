...
[![Go](https://github.com/akosyakov/protoc-gen-connect-openapi/actions/workflows/go.yml/badge.svg)](https://github.com/akosyakov/protoc-gen-connect-openapi/actions/workflows/go.yml) [![Go Report Card](https://goreportcard.com/badge/github.com/akosyakov/protoc-gen-connect-openapi)](https://goreportcard.com/report/github.com/akosyakov/protoc-gen-connect-openapi) [![Go Reference](https://pkg.go.dev/badge/github.com/akosyakov/protoc-gen-connect-openapi.svg)](https://pkg.go.dev/github.com/akosyakov/protoc-gen-connect-openapi)
...
- Has [an easy interface](https://pkg.go.dev/github.com/akosyakov/protoc-gen-connect-openapi/converter) for generating OpenAPI specs within the process
...
## Install
```shell
go install github.com/akosyakov/protoc-gen-connect-openapi@main
```

or you can download pre-built binaries from the [Github releases page](https://github.com/akosyakov/protoc-gen-connect-openapi/releases/latest).
